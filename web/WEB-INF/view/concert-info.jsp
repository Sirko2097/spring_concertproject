...
<div class="container">
    <div class="jumbotron">
        <h2 align="center">${concert.concertName}</h2>
        <br>
        <h4 align="center">${concert.concertDate}</h4>
        <br>
        Break: ${concert.breakName}
        <br>
        <h4>Announcer: ${concert.announcerName}</h4>
        <br>
...
<div class="btn-group btn-group-justified">
    <a class="btn btn-primary" href="${pageContext.request.contextPath}/concerts/${concert.concertId}/addperformer">Add performer</a>
